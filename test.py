...
_DATA_ROOT = {
    'ucf101': {
        'rgb': '/media/zoro/ZORO/UCF-101-FRAME/ApplyEyeMakeup/v_ApplyEyeMakeup_g01_c01',
...
_CHECKPOINT_PATHS = {
    'rgb': '/home/zoro/AI/action_recognition/I3D_Finetune/model/ucf101_rgb_0.925_model-23920',
...
#        print('input_label.shape:', input_label.shape)
        ...
        # self_added
        test_argmax = np.argmax(predictions, axis=1)
        print(test_argmax)
        test_argmax_0 = test_argmax[0]
        print(test_argmax_0)
